...
for z=1:5
    ...
    %noiseless
        ...
        for i=1:103
          ...
          mx=max(paviaw(:));
          mn=min(paviaw(:));
          I1=uint8(round(((paviaw-mn)/(mx-mn))*255));
          Data2(:,:,i)=I1;
        end   
        end
        %Gaussian
    ...
    II=Itransformed(:,1:75);
    window1=reshape(II,size(A1,1),75);

    coeff=pca(A2);
    Itransformed = A2*coeff;
    II=Itransformed(:,1:75);
    window2=reshape(II,size(A2,1),75);

    coeff=pca(A3);
    Itransformed = A3*coeff;
    II=Itransformed(:,1:75);
    window3=reshape(II,size(A3,1),75);

    coeff=pca(A4);
    Itransformed = A4*coeff;
    II=Itransformed(:,1:75);
    window4=reshape(II,size(A4,1),75);

    coeff=pca(A5);
    Itransformed = A5*coeff;
    II=Itransformed(:,1:75);
    window5=reshape(II,size(A5,1),75);

    coeff=pca(A6);
    Itransformed = A6*coeff;
    II=Itransformed(:,1:75);
    window6=reshape(II,size(A6,1),75);

    coeff=pca(A7);
    Itransformed = A7*coeff;
    II=Itransformed(:,1:75);
    window7=reshape(II,size(A7,1),75);

    coeff=pca(A8);
    Itransformed = A8*coeff;
    II=Itransformed(:,1:75);
    window8=reshape(II,size(A8,1),75);

    coeff=pca(A9);
    Itransformed = A9*coeff;
    II=Itransformed(:,1:75);
    window9=reshape(II,size(A9,1),75);
    ...
    for jj=1:size(window4,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(4),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    ...
    for jj=1:size(window5,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(5),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    ...
    for jj=1:size(window6,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(6),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    ...
    for jj=1:size(window7,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(7),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    ...
    for jj=1:size(window8,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(8),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    ...
    for jj=1:size(window9,1)
        ...
        FImage=uint8(FImage);
        FImage=imresize(FImage,[224,224]);
        filename=[num2str(9),'-',num2str(jj),'.jpg'];
        imwrite(FImage,filename);
    end
    cd ..
    if k==1
