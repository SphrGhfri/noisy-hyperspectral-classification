...
for i in range(1,50) :
    ...
    out = Dense(16 , activation='softmax', name='output')(x)
    ...
    train_generator = train_datagen.flow_from_directory(
        directory='Salinas_Split_data/train/noiseless',
        target_size=(224, 224),
        batch_size=20,
    ...
    valid_generator = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/noiseless',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
...
# -------------------------------------------------------------------------------------------------------------   
    valid_generator1 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/gaussian/noise5',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator2 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/gaussian/noise10',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator3 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/gaussian/noise15',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator4 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/gaussian/noise20',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator5 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/gaussian/noise25',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
...
# -----------------------------------------------------------------------------------------   
    valid_generator6 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/saltPepper/noise5',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator7 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/saltPepper/noise10',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator8 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/saltPepper/noise15',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator9 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/saltPepper/noise20',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator10 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/saltPepper/noise25',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
...
#  ---------------------------------------------------------------------------------------------  
    valid_generator11 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/stripe/noise5',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator12 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/stripe/noise10',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator13 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/stripe/noise15',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator14 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/stripe/noise20',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    valid_generator15 = valid_datagen.flow_from_directory(
        directory='Salinas_Split_data/validation/stripe/noise25',
        target_size=(224, 224),
        batch_size=20,
        class_mode="categorical",
        shuffle=True,
    ...
    def pseudo_huber(y_true, y_pred,delta=1):
        a=y_pred-y_true
        a=K.abs(a)
        return ((delta**2)*((K.sqrt(1+(K.pow((a/delta),2)))-1)))
